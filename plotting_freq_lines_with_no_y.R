...
#oversharing is better than under. SEE LINES 51:71 for solution. 
...
#Only works if all the way clean..
...
#see how "status_notes" and "agency_responsible" are called on seperate?
sanfran_clean_no_na_2 <- sanfran_clean_no_na_1[grep("Duplicate", sanfran_clean_no_na_1$agency_responsible, invert = TRUE), ]

#calls with "nothing" in response narrative. R
#eflecting false alarm or duplicate frequency counts.
...
#Note: the date_only vector is just that, a single column 
