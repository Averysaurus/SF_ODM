...
# 12 cumulatove incidence one month before. 
tmap_mode('view')
tm_shape(odm_soma) +
...
### plotted over time.
raw_incidence_bef <- st_drop_geometry(third_natoma_box_bef)
raw_incidence_aft <- st_drop_geometry(third_natoma_box_aft)
